...
use crate::{start_cheat_contract_address_global, stop_cheat_contract_address_global};
...
pub fn interact_with_state<F, +Drop<F>, impl func: core::ops::FnOnce<F, ()>, +Drop<func::Output>>(
    ...
    start_cheat_contract_address_global(contract_address);
    let res = f();
    stop_cheat_contract_address_global();
    res
}
